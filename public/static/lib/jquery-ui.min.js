...
!function(t) {
    ...
    x.ui = x.ui || {};
    x.ui.version = "1.13.1";
    var n, i = 0, l = Array.prototype.hasOwnProperty, a = Array.prototype.slice;
    ...
    x.widget = function(t, i, e) {
        var s, n, o, l = {}, a = t.split(".")[0], r = a + "-" + (t = t.split(".")[1]);
        return e || (e = i,
        i = x.Widget),
        ...
        x.each(e, function(e, s) {
            ...
            l[e] = "function" == typeof s ? function() {
    ...
    x.widget.extend = function(t) {
        for (var e, i, s = a.call(arguments, 1), n = 0, o = s.length; n < o; n++)
            for (e in s[n])
                i = s[n][e],
                l.call(s[n], e) && void 0 !== i && (x.isPlainObject(i) ? t[e] = x.isPlainObject(t[e]) ? x.widget.extend({}, t[e], i) : x.widget.extend({}, i) : t[e] = i);
        return t
    }
    ,
    x.widget.bridge = function(o, e) {
        ...
        x.fn[o] = function(i) {
            ...
            return t ? this.length || "instance" !== i ? this.each(function() {
                ...
                !1) : e ? "function" != typeof e[i] || "_" === i.charAt(0) ? x.error("no such method '" + i + "' for " + o + " widget instance") : (t = e[i].apply(e, s)) !== e && void 0 !== t ? (n = t && t.jquery ? n.pushStack(t.get()) : t,
                !1) : void 0 : x.error("cannot call methods on " + o + " prior to initialization; attempted to call method '" + i + "'")
            }) : n = void 0 : (s.length && (i = x.widget.extend.apply(null, [i].concat(s))),
            this.each(function() {
                var t = x.data(this, l);
                t ? (t.option(i || {}),
                t._init && t._init()) : x.data(this, l, new e(i,this))
            })),
            n
        }
    }
    ...
    x.Widget.prototype = {
                ...
                for (var i, s = 0; s < t.length; s++)
                    ...
                    i = n.add ? (function() {
                        ...
                        n.element.each(function(t, e) {
                            x.map(l.classesElementLookup, function(t) {
                                return t
                            }).some(function(t) {
                                return t.is(e)
                            }) || i.push(e)
        ...
        _on: function(n, o, t) {
            ...
            x.each(t, function(t, e) {
                function i() {
                    if (n || !0 !== a.options.disabled && !x(this).hasClass("ui-state-disabled"))
    ...
    x.each({
        ...
        x.Widget.prototype["_" + o] = function(e, t, i) {
            var s, n = (t = "string" == typeof t ? {
                effect: t
            } : t) ? !0 !== t && "number" != typeof t && t.effect || l : o;
            "number" == typeof (t = t || {}) ? t = {
                duration: t
            } : !0 === t && (t = {}),
            s = !x.isEmptyObject(t),
    ...
    x.fn.position = function(c) {
        ...
        var d, f, m, p, v, t, g = "string" == typeof (c = x.extend({}, c)).of ? x(document).find(c.of) : x(c.of), _ = x.position.getWithinInfo(c.within), y = x.position.getScrollInfo(_), b = (c.collision || "flip").split(" "), w = {}, e = 9 === (t = (e = g)[0]).nodeType ? {
            width: e.width(),
            height: e.height(),
            offset: {
                top: 0,
        ...
        return g[0].preventDefault && (c.at = "left top"),
        f = e.width,
        m = e.height,
        ...
        1 === b.length && (b[1] = b[0]),
        "right" === c.at[0] ? v.left += f : "center" === c.at[0] && (v.left += f / 2),
        "bottom" === c.at[1] ? v.top += m : "center" === c.at[1] && (v.top += m / 2),
        d = T(w.at, f, m),
        v.left += d[0],
        v.top += d[1],
        this.each(function() {
            var i, t, l = x(this), a = l.outerWidth(), r = l.outerHeight(), e = A(this, "marginLeft"), s = A(this, "marginTop"), n = a + e + A(this, "marginRight") + y.width, o = r + s + A(this, "marginBottom") + y.height, u = x.extend({}, v), h = T(w.my, l.outerWidth(), l.outerHeight());
            "right" === c.my[0] ? u.left -= a : "center" === c.my[0] && (u.left -= a / 2),
            "bottom" === c.my[1] ? u.top -= r : "center" === c.my[1] && (u.top -= r / 2),
            u.left += h[0],
            u.top += h[1],
            i = {
                marginLeft: e,
            ...
            c.using && (t = function(t) {
                ...
                C(E(e), E(i)) > C(E(s), E(n)) ? o.important = "horizontal" : o.important = "vertical",
    ...
    x.ui.position = {
        fit: {
            left: function(t, e) {
                ...
                e.collisionWidth > n ? 0 < l && a <= 0 ? (i = t.left + l + e.collisionWidth - n - s,
                t.left += l - i) : t.left = !(0 < a && l <= 0) && a < l ? s + n - e.collisionWidth : s : 0 < l ? t.left += l : 0 < a ? t.left -= a : t.left = C(t.left - o, t.left)
            },
            top: function(t, e) {
                var i = e.within
                ...
                e.collisionHeight > n ? 0 < l && a <= 0 ? (i = t.top + l + e.collisionHeight - n - s,
                t.top += l - i) : t.top = !(0 < a && l <= 0) && a < l ? s + n - e.collisionHeight : s : 0 < l ? t.top += l : 0 < a ? t.top -= a : t.top = C(t.top - o, t.top)
            }
        },
        flip: {
            left: function(t, e) {
